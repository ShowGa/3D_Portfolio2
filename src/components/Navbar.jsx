...
import { ShowGa, menu, close } from "../assets";

const Navbar = () => {
  // track where we are in the page
  const [active, setActive] = useState(" ");
  const [toggle, setToggle] = useState(false);

  return (
    // fixed will be out of this word
    <nav
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl  mx-auto">
        ...
        >
          <img src={ShowGa} alt="logo" className="w-9 h-9 object-contain" />
